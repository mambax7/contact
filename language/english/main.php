...
define('_MD_CONTACT_MES_NONAME', 'Please enter your name');
define('_MD_CONTACT_MES_NOSUBJECT', 'Please enter a subject');
define('_MD_CONTACT_MES_NOMESSAGE', 'Please enter a message');
