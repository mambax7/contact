...
<div class="row contact-row bg-contact">
<{if $block.info}>
    <div id="contact-info" class="col-xs-12 col-sm-12 col-md-12 col-lg-12 contact-info-text text-center">
        <{$block.info}>
    </div>
<{/if}>
    ...
    <div id="contact-form" class="contact-form col-xs-12 col-sm-12 col-md-9 col-lg-9">
<{else}>
